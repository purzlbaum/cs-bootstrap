 ...
 * 1. /theme/assets/css/default.css
 *
...
function roots_scripts() {
  ...
  if (WP_ENV === 'development') {
    ...
    $assets     = array(
      'css'       => '/assets/css/default.min.css?' . $assets['assets/css/default.min.css']['hash'],
  ...
  wp_enqueue_style('cs-bootstrap_css', get_template_directory_uri() . $assets['css'], false, null);
